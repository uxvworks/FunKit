...
/*
 * Setup for MIKROE CLICKER M4 STM32 .
 */

/*
 * Board identifier.
 */
#define BOARD_MIKROE_STM32M4
#define BOARD_NAME                  "Mikroe STM32M4 Clicker"
...
#define     PIN_BUT2                 GPIOC_PIN1

#define     PIN_LED1                 GPIOA_PIN1
#define     PIN_LED2                 GPIOA_PIN2
...
#define     LINE_LED1                 PAL_LINE(GPIOA, PIN_LED1)
#define     LINE_LED2                 PAL_LINE(GPIOA, PIN_LED2)
...
#define VAL_GPIOA_ODR               (PIN_ODR_HIGH(GPIOA_PIN1) |           \
...
#define VAL_GPIOA_AFRL              (PIN_AFIO_AF(GPIOA_PIN1, 0U) |        \
                                     PIN_AFIO_AF(PIN_LED1, 0U) |          \
 ...
 * GPIOC setup:
 *
 * PC0  - PIN_BUT1                  (input floating).
 * PC1  - PIN_BUT2                  (input floating).
