...
static THD_FUNCTION(can_rx, p)
{
    ...
    while(true) {
        if(chEvtWaitAnyTimeout(ALL_EVENTS, MS2ST(100)) == 0)
            continue;
        while(canReceive(cip->canp, CAN_ANY_MAILBOX, &rxmsg, TIME_IMMEDIATE) == MSG_OK) {
            /* Process message.*/
...
// CAN PERIPHERAL
//#define HW_CAN1_GPIO_AF      GPIO_AF_CAN1
//#define HW_CAN1_TX_PORT      GPIOB
//#define HW_CAN1_TX_PIN       9
//#define HW_CAN1_RX_PORT      GPIOB
//#define HW_CAN1_RX_PIN       8

//#define HW_CAN2_GPIO_AF      GPIO_AF_CAN2  
//#define HW_CAN2_TX_PORT      GPIOB
//#define HW_CAN2_TX_PIN       6
//#define HW_CAN2_RX_PORT      GPIOB
//#define HW_CAN2_RX_PIN       12
...
int main(void)
{
     ...
     */
    //palSetPadMode(HW_CAN1_TX_PORT,
    //              HW_CAN1_TX_PIN,
    //              PAL_MODE_ALTERNATE(HW_CAN1_GPIO_AF) | PAL_STM32_OTYPE_PUSHPULL | PAL_STM32_OSPEED_MID1);
    //palSetPadMode(HW_CAN1_RX_PORT,
    //              HW_CAN1_RX_PIN,
    //              PAL_MODE_ALTERNATE(HW_CAN1_GPIO_AF) | PAL_STM32_OTYPE_PUSHPULL | PAL_STM32_OSPEED_MID1);
    //palSetPadMode(HW_CAN2_TX_PORT,
    //              HW_CAN2_TX_PIN,
    //              PAL_MODE_ALTERNATE(HW_CAN2_GPIO_AF) | PAL_STM32_OTYPE_PUSHPULL | PAL_STM32_OSPEED_MID1);
