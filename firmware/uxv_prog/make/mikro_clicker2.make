...
BOARDDIR := ../boards
CONFDIR  := ./cfg/mikro_clicker2
BUILDDIR := ./build/mikro_clicker2
DEPDIR   := ./.dep/mikro_clicker2
...
include $(BOARDDIR)/MIKROE_CLICKER2_STM32/board.mk
